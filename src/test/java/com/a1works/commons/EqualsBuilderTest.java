...
public class EqualsBuilderTest {
    ...
    @Test
    public void testGettersAreCorrect(){
        MayBe<EqualsBuilder<TestEntityObject>> mayBeBuilder = EqualsBuilder.createInstanceIfParamsHaveSameType(obj1, obj2);
        assertFalse("EqualsBuilder.createInstanceIfParamsHaveSameType() should not return an empty MayBe as the 2 parameters are valid.", mayBeBuilder.isEmpty());
        EqualsBuilder<TestEntityObject> builder = mayBeBuilder.get();
        assertTrue("EqualsBuilder.getTargetObject() should return the first parameter passed to it.", builder.getTargetObject() == obj1);
        assertTrue("EqualsBuilder.getOtherObject() should return the second parameter passed to it.", builder.getOtherObject() == obj2);
    }
